...
namespace GUI.Ferramentas.Controles
{
        ...
        public class ButttomCustom1 : Control, IButtonControl
        {
            public ButttomCustom1() : base()
            {
        ...
        public class RoundCornersEditor : UITypeEditor
        {
            ...
            public override Object EditValue(ITypeDescriptorContext context, IServiceProvider provider, Object value)
            {
                ...
                if (edSvc != null)
                {
                    ...
                    lb.Items.Add("TopLeft", (((ButttomCustom1)context.Instance).RoundCorners & Corners.TopLeft) == Corners.TopLeft);
                    lb.Items.Add("TopRight", (((ButttomCustom1)context.Instance).RoundCorners & Corners.TopRight) == Corners.TopRight);
                    lb.Items.Add("BottomLeft", (((ButttomCustom1)context.Instance).RoundCorners & Corners.BottomLeft) == Corners.BottomLeft);
                    lb.Items.Add("BottomRight", (((ButttomCustom1)context.Instance).RoundCorners & Corners.BottomRight) == Corners.BottomRight);
